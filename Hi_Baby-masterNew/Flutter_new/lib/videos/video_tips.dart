...
class videotips extends StatefulWidget {
  const videotips({Key key}) : super(key: key);

  @override
  _videotipsState createState() => _videotipsState();
}

class _videotipsState extends State<videotips> {
  List videoInfo = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/videotips.json")
        .then((value) {
      setState(() {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "Some useful tips you can apply",
                      style: TextStyle(
                          fontSize: 20,
                          fontStyle: FontStyle.italic,
