...
class _Baby_sitterState extends State<Baby_sitter> {
  ...
  Future getdata() async {
    var uri = Uri.parse("http://192.168.232.2/Hi_Baby/baby_sitter.php");
  ...
  Future searchdata() async {
    var uri = Uri.parse("http://192.168.232.2/Hi_Baby/search_sitter.php");
    var response = await http.get(uri);
    var responsebody = jsonDecode(response.body);
...
class Datasearch extends SearchDelegate<String> {
  ...
  Future getsAdv() async {
    var uri = Uri.parse("http://192.168.232.2/Hi_Baby/searchsitter_adv.php");
