...
class AgeCalculator {
  ...
  /// add method
  static DateTime add({DateTime date, DateDuration duration}) {
  ...
  static DateDuration age(DateTime birthdate, {today}) {
    return dateDifference(fromDate: birthdate, toDate: today ?? DateTime.now());
  }

  static DateDuration timeToNextBirthday(DateTime birthdate, {fromDate}) {
